...
function Test() {
  ...
  const CreateTodo = async (BodyData) => {
    const Response = await fetch(
      `http://localhost:3001/user/todo?Id=${user_id}&userName=Ar`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  const DeleteTodo = async (TodoId) => {
    //console.log(TodoId);
    const response = await fetch(
      `http://localhost:3001/user/todo?todoId=${TodoId}`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
  ...
  const TodoComplete = async (TodoId, CompleteStatus) => {
    const response = await fetch(
      `http://localhost:3001/user/todo/complete/${TodoId}`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
  ...
  async function UpdateStats(Todo_Id) {
    const response = await fetch(
      `http://localhost:3001/user/stats/update?userId=${user_id}&todoId=${Todo_Id}&token=${token}`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
